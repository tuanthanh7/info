jQuery(document).ready(function ($) {
    ...
    /* Make it sortable. */
    $('ul.storeship-multicheck-sortable-list').sortable({
        handle: '.storeship-multicheck-sortable-handle',
        axis: 'y',
        update: function (e, ui) {
            $('input.storeship-multicheck-sortable-item').trigger('change');
        }
    });

    /* On changing the value. */
    $("input.storeship-multicheck-sortable-item").on('change', function () {

        /* Get the value, and convert to string. */
        var this_checkboxes_values = $(this).parents('ul.storeship-multicheck-sortable-list').find('input.storeship-multicheck-sortable-item').map(function () {
            var active = '0';
        ...
        $(this).parents('ul.storeship-multicheck-sortable-list').find('input.storeship-multicheck-sortable').val(this_checkboxes_values).trigger('change');
    ...
    /* On changing the value. */
    $("input.storeship-multicheck-item").on('change', function () {

        /* Get the value (only the "checked" item), and convert to comma separated string. */
        var this_checkboxes_values = $(this).parents('ul.storeship-multicheck-list').find('input.storeship-multicheck-item:checked').map(function () {
            return this.name;
        }).get().join(',');

        /* Add the value to hidden input. */
        $(this).parents('ul.storeship-multicheck-list').find('input.storeship-multicheck').val(this_checkboxes_values).trigger('change');
